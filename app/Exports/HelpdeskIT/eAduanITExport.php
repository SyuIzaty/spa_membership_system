...
namespace App\Exports\HelpdeskIT;
...
class eAduanITExport implements FromView, WithColumnFormatting
{
    protected $tahun;
    protected $bulan;
    protected $kategori;
    ...
    public function view(): View
    {
        ...
        $data = $data->whereNotIn('status_aduan', ['AB'])->whereIn('kategori_aduan', ['IITU-HDWR','IITU-NTWK','IITU-OPR_EMEL','IITU-NTWK WIRELESS'])->get();
