...
class iComplaintExportByYear implements FromView, WithEvents, WithStyles, WithDrawings
{
    ...
    {
        $year = $this->year;
        $list = AduanKorporat::whereYear('created_at', $year)->get();
        $log = AduanKorporatLog::whereYear('created_at', $year)->where('activity','Completed');

        return view('aduan-korporat.export-report-year', compact('list','log','year'));
    }
