...
class AssetTrail extends Model
{
    ...
    protected $fillable = [
        ...
        'custodian_id', 'created_by', 'remark', 'status', 'inactive_reason', 'inactive_remark', 'inactive_date', 'availability', 'space_room_id', 'set_package', 'updated_by', 'asset_id', 'vendor_name'
    ];
