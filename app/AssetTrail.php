...
class AssetTrail extends Model
{
    ...
    protected $fillable = [
        'asset_code', 'asset_code_type', 'finance_code', 'asset_name', 'asset_type', 'serial_no', 'model', 'brand', 'total_price', 'lo_no', 'io_no', 'do_no', 'purchase_date', 
        'custodian_id', 'created_by', 'remark', 'status', 'inactive_date', 'availability', 'storage_location', 'set_package', 'updated_by', 'asset_id', 'vendor_name'
    ];
    ...
    {
        return $this->hasOne('App\AssetStatus', 'id', 'status');
    }
