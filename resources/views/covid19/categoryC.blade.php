...
<main id="js-page-content" role="main" class="page-content" style="background-image: url({{asset('img/bg-form.jpg')}}); background-size: cover">
    <div class="subheader">
        ...
        <i class='subheader-icon fal fa-paperclip'></i>Category C Management
        </h1>
    </div>
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        Category C <span class="fw-300"><i>List</i></span>
                    </h2>
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        <div class="table-responsive">
                            <table id="catC" class="table table-bordered table-hover table-striped w-100">
                                <thead>
...
<script>
    ...
    {
        $('#catC thead tr .hasinput').each(function(i)
        {
        ...
        $('#catC').on('click', '.btn-delete[data-remote]', function (e) {
            e.preventDefault();
            $.ajaxSetup({
                headers: {
