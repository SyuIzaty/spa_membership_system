                                                ...
                                                <thead>
                                                    <tr>
                                                        <div class="form-group">
                                                            <th style="text-align: center; border-left-style: hidden; border-right-style: hidden; vertical-align: middle"><label style="width: 75px">Full Name : </label></th>
                                                            <td style=" border-right-style: hidden; vertical-align: middle">
                                                            ...
                                                            <th style="text-align: center; border-right-style: hidden; vertical-align: middle"><label style="width: 150px">Staff ID / Student ID: </label></th>
                                                            <td style=" border-right-style: hidden; vertical-align: middle">
                                                                <input style="width: 150px" class="form-control user_id" id="user_id" name="user_id"  value="{{ old('user_id') }}" readonly>
                                                            </td>
                                                            <th style="text-align: center; border-right-style: hidden; vertical-align: middle"><label style="width: 80px">Email : </label></th>
                                                            <td style=" border-right-style: hidden; vertical-align: middle">
                                                                <input style="width: 250px" class="form-control user_email" id="user_email" name="user_email"  value="{{ old('user_email') }}" readonly>
                                                            </td>
                                                            <th style="text-align: center; border-right-style: hidden; vertical-align: middle"><label style="width: 80px">Phone No. : </label></th>
                                                            <td style=" border-right-style: hidden; vertical-align: middle">
                                                                <input style="width: 150px" class="form-control" id="user_phone" name="user_phone"  value="{{ old('user_phone') }}">
                                                            </td>
                                                        </div>
                                                    </tr>
                                                </thead>
