...
<main id="js-page-content" role="main" class="page-content">
    <div class="subheader">
        ...
        <i class='subheader-icon fal fa-university'></i>Active Lead
        </h1>
    </div>
    <div class="row">
        <div class="col-xl-12">
...
<script>
    $(document).ready(function()
    {
        ...
        $('#lead thead tr .hasinput').each(function(i)
        {
        ...
        $('#lead').on('click', '.btn-delete[data-remote]', function (e) {
            e.preventDefault();
            $.ajaxSetup({
                headers: {
