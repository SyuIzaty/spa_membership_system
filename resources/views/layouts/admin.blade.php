                ...
                <nav id="js-primary-nav" class="primary-nav" role="navigation">
                    ...
                    <ul id="js-nav-menu" class="nav-menu">
                        ...
                        @can('View File Classification')
                            ...
                            <li>
                                <a href="/file-classification-note" style="text-decoration: none!important;"
                                    title="File Classification Note" data-filter-tags="fileNote" target="_blank">
                                    <i class="fal fa-info"></i>
                                    <span class="nav-link-text" data-i18n="nav.fileNote">Note</span>
                                </a>
                            </li>
                                        ...
                                        <li>
                                            <a href="/stationery-manage/NA" title="parameter" data-filter-tags="parameter">
                                                <span class="nav-link-text" data-i18n="nav.parameter">New Application
                                                    ({{ $application->countNewApplication() }})
                                                </span>
                                            </a>
                                        </li>
                                        <li>
                        ...
                        @can('view inventory menu')
                            ...
                            {{-- @can('view inventory dashboard')
                                    <li>
                                        <a href="/inventory-dashboard" title="Application Intel"
                                            data-filter-tags="application intel">
                                            <i class="fal fa-chart-pie"></i>
                                ...
                                @endcan --}}
                            @canany(['admin management', 'manager management'])
                                <li class="open">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="/asset-list" title="Detail" data-filter-tags="detail">
                                                <span class="nav-link-text" data-i18n="nav.detail"> Asset Detail</span>
                                            </a>
                                        </li>
                                        @can('admin management')
                                            <li>
                                                <a href="/asset-bulk-upload" title="Upload" data-filter-tags="upload">
                                                    <span class="nav-link-text" data-i18n="nav.upload"> Bulk Upload</span>
                                                </a>
                                            </li>
                                        @endcan
                                        <li>
                                            <a href="/asset-report" title="Report" data-filter-tags="report">
                                ...
                                @can('admin management')
                                    <li class="open">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <a href="/asset-department" title="Manager" data-filter-tags="manager">
                                ...
                                @endcan
                                {{-- <li class="open">
                                        <a href="/asset-search" title="Asset Search" data-filter-tags="assetSearch">
