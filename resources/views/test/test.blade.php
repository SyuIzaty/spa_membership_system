                ...
                <div id="panel-1" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <center><img src="{{ asset('img/intec_logo_new.png') }}" style="height: 70px; width: 260px;">
                            </center><br>
                            ...
                            <div class="panel-content">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table id="rent" class="table table-bordered table-hover table-striped w-100">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input class="form-control" type="date" name="rentdate" size="40"
                                                    required>
                                                @error('rentdate')
                                                    <p style="color: red"><strong> {{ $message }} </strong></p>
                                                @enderror
                                            ...
                                            <td>
                                                <input class="form-control" type="date" name="retdate" size="40"
                                                    required>
                                                @error('rentdate')
                                                    <p style="color: red"><strong> {{ $message }} </strong></p>
                                                @enderror
                                ...
                                <table class="table table-bordered table-hover table-striped w-80" align="center"
                                    ...
                                    @foreach ($equipment as $equipments)
                                        <tr>
                                            <td>
                                                <input name="equipment_id" id="{{ $equipments->id }}" type="checkbox"
                                                    value="{{ $equipments->id }}">
                                            </td>
                                            <td>{{ $equipments->equipment_name }}</td>
                                            <td><input class="form-control" type="text"
                                                    name="sn[{{ $equipments->id }}]" width="400"></td>
                                            <td><input class="form-control" type="text"
                                                    name="des[{{ $equipments->id }}]" size="50"></td>
                                        </tr>
                                    @endforeach
                                </table><br />
                                <div align="center">
                                ...
                                <h5>1. I agree to be responsible for all the equipment I am renting, as documented on this
                                    form.</h5>
                                <h5>2. Borrowed equipment will be returned no later than 1 DAY after the last date of use.
                                </h5>
                                <h5>3. I may be subject to action if I do not comply with the rules.</h5><br>
                                {{-- <table>
                                    <tr>
                                        <th>.......................................</th>
                                        <th></th>
                                ...
                                <a href="javascript:window.print()" download="document.docx"
                                    class="btn btn-primary float-center waves-effect waves-themed">Download File</a>
                            </div>
                        </div>
                    </div>
                </div>
