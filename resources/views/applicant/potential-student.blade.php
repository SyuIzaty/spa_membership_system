                                    ...
                                    <tr>
                                        <td valign="middle" style="font-size: 13px; line-height: 22px;">
                                            <span style="font-family: Arial, Helvetica, sans-serif; font-size: 13px;">
                                                <div style="line-height: 80px">Dear Potential Student,</div>
                                                <p>Thank you for choosing INTEC as your preferred learning institution.</p>
                                                <p>Kindly be informed that your application has been received and will be processed for admission placement at INTEC Education College.</p>
                                                <p>Successful candidate will be notified via email within 30 days from your application date.</p>
