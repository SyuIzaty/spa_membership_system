...
<main id="js-page-content" role="main" class="page-content">
    ...
    <div class="subheader">
        ...
        <i class='subheader-icon fal fa-table'></i> Courses<!--span class='fw-300'>ColumnFilter</span> <sup class='badge badge-primary fw-500'>ADDON</sup-->
            <!--small>
            ...
            <div id="panel-1" class="panel">
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        ...
                        <table id="courses" class="table table-bordered table-hover table-striped w-100">
...
<script>
    $(document).ready(function()
    {
        ...
        var table = $('#courses').DataTable({
            ...
            columns: [
                    { data: 'cm_course_code', name: 'cm_course_code'},
                    { data: 'cm_course_desc', name: 'cm_course_desc' },
                    { data: 'cm_program_code', name: 'cm_program_code' },
                    { data: 'cm_credit_hour', name: 'cm_credit_hour' },
                    { data: 'cm_active', name: 'cm_active' },
                    { data: 'cm_lecture_hour', name: 'cm_lecture_hour' },
                    { data: 'cm_exam', name: 'cm_exam' },
                    { data: 'cm_result_counted', name: 'cm_result_counted'},
                    { data: 'cm_sor', name: 'cm_sor'},
