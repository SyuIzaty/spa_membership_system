    ...
    $(document).ready(function()
    {
        ...
        var table = $('#application').DataTable({
            ...
            columns: [
                    ...
                    { className: 'text-left', data: 'staff_id', name: 'staff_id' },
                    { className: 'text-left', data: 'details', name: 'details' },
                    { className: 'text-left', data: 'status', name: 'status' },
                    { className: 'text-left', data: 'price', name: 'price' },
                    { className: 'text-left', data: 'amount', name: 'amount' },
                    { className: 'text-left', data: 'type', name: 'type' },
                    { className: 'text-left', data: 'purchase', name: 'purchase' },
                    { className: 'text-left', data: 'approvalDate', name: 'approvalDate' },
                    { className: 'text-left', data: 'expiryDate', name: 'expiryDate' },
                    { className: 'text-left', data: 'remainingPeriod', name: 'remainingPeriod' },
                    { className: 'text-left', data: 'penalty', name: 'penalty' },
                    { className: 'text-left', data: 'action', name: 'action', orderable: false, searchable: false},
                    { className: 'text-left', data: 'log', name: 'log', orderable: false, searchable: false} 
                ],
                orderCellsTop: true,
                "order": [[ 1, "asc" ]],
