                ...
                <div id="panel-2" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <a href="javascript:void(0);" class="card-title collapsed"
                                                    ...
                                                    data-target="#js_demo_accordion-{{ $i }}"
                                                    aria-expanded="false">
                                                    {{ $f->question }}
                                                    <span class="ml-auto">
                                            ...
                                            <div id="js_demo_accordion-{{ $i }}" class="collapse"
                                                data-parent="#js_demo_accordion-3" style="">
                                                <div class="card-body">
                                                    {!! nl2br($f->answer) !!}
                                                </div>
                                            </div>
                            ...
                            <a class="btn btn-success float-right mb-2" target="_blank" href="/Grant-System-Flow-Chart">
                                <i class="fal fa-download"></i> System Flow Chart
                            </a>
                        </div>
                    </div>
                </div>
