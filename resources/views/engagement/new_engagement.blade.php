        ...
        <div class="row">
            <div class="col-xl-12">
                <div id="panel-1" class="panel">
                        ...
                        <div class="panel-content">
                                <div class="card card-primary card-outline">
                                    ...
                                    <div class="card-body">
                                        ...
                                        @endif
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-hover table-striped w-100" id="addtodo">
                                                <thead>
                    ...
                    <button type="submit" class="btn btn-primary ml-auto float-right" style="margin-right: 20px; margin-bottom: 20px;"><i class="fal fa-save"></i> Save</button>
