...
<main id="js-page-content" role="main" class="page-content">
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-plus-circle'></i> Major Information Update
        </h1>
    </div>
    <div class="row">
        ...
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        Update Major : <span class="fw-300"><i> {{ $major->major_name }}</i></span>
                    </h2>
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        <form action="{{ route('major.update', $major->id) }}" enctype="multipart/form-data" method="POST"> 
                            @method('PUT')
                            ...
                            <tr>
                                <div class="form-group">   
                                    <td width="15%"><label class="form-label" for="id">Major ID <span class="text-danger">*</span></label></td>
                                        <td colspan="5"><input class="form-control @error('id') is-invalid @enderror" id="id" name="id" value="{{ $major->id }}" readonly>
                                            @error('id')
                                    ...
                                    <td width="15%"><label class="form-label" for="major_code">Major Code <span class="text-danger">*</span></label></td>
                                        <td colspan="5"><input class="form-control @error('major_code') is-invalid @enderror" id="major_code" name="major_code" value="{{ $major->major_code }}">
                                            @error('major_code')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong> *{{ $message }} </strong>
                                                </span>
                            ...
                            <tr>
                                <div class="form-group">
                                    ...
                                    <td colspan="5"><input class="form-control @error('major_name') is-invalid @enderror" id="major_name" name="major_name" value="{{ $major->major_name }}">
                                        @error('major_name')
                                            <span class="invalid-feedback" role="alert">
                                                <strong> *{{ $message }} </strong>
                                            </span>
                                    ...
                                    <td width="15%"><label class="form-label" for="major_status">Status <span class="text-danger">*</span></label></td>
                                        <td colspan="5"><select class="form-control @error('major_status') is-invalid @enderror" id="major_status" name="major_status">
                                            ...
                                            <option value="1" {{ old('major_status', $major->major_status) == '1' ? 'selected':''}} >Active</option>
                                            <option value="0" {{ old('major_status', $major->major_status) == '0' ? 'selected':''}} >Inactive</option>
                                        </select>
                                        @error('major_status')
                                        <span class="invalid-feedback" role="alert">
                                            <strong> *{{ $message }} </strong>
