...
<main id="js-page-content" role="main" class="page-content">
    ...
    <div class="subheader">
        ...
        <i class='subheader-icon fal fa-table'></i>Students with Non-Numeric StudentID<!--span class='fw-300'>ColumnFilter</span> <sup class='badge badge-primary fw-500'>ADDON</sup-->
            <!--small>
...
<script>
    $(document).ready(function()
    {
        ...
        var table = $('#students').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "/data_studentWithNonNumericId",
                type: 'POST',
