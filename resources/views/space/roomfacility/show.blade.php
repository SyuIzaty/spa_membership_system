...
<main id="js-page-content" role="main" class="page-content">
    ...
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-plus-circle'></i> Room Facility Information
            {{-- <small>
    ...
    <div class="row">
        ...
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        View <span class="fw-300"><i>Room Facility {{ $roomfacility->name }}</i></span>
                    </h2>
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        <table id="roomtype" class="table table-bordered table-hover table-striped w-100">
                            <thead>
                                <tr>
                                    <td width="21%"><b>ROOM FACILITY CODE :</b></td>
                                    <td colspan="2">{{ $roomfacility->code }}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">{{ $roomfacility->description }}</td>
                                </tr>
                                <tr>
                                    <td width="21%"><b>ACTIVE STATUS :</b></td>
                                    <td colspan="2">{{ $roomfacility->active }}</td>
                                </tr>
                            </thead>
                        </table>
                    </div>
                    ...
                    <div class="panel-content py-2 rounded-bottom border-faded border-left-0 border-right-0 border-bottom-0 text-muted">
                        <a href="/space/roomfacility/{{$roomfacility->id}}/edit" class="btn btn-warning ml-auto float-right"><i class="fal fa-pencil"></i> Edit</a> 
