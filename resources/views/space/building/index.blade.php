...
<main id="js-page-content" role="main" class="page-content">
    ...
    <div class="subheader">
        ...
        <i class='subheader-icon fal fa-building'></i>Building<!--span class='fw-300'>ColumnFilter</span> <sup class='badge badge-primary fw-500'>ADDON</sup-->
            <!--small>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        Building<span class="fw-300"><i>List</i></span>
                    </h2>
                ...
                <div class="panel-container show">
                    ...
                    <div class="panel-content py-2 rounded-bottom border-faded border-left-0 border-right-0 border-bottom-0 text-muted d-flex  pull-right">
                        ...
                        <a href="/space/building/create" class="btn btn-primary ml-auto"><i class="fal fa-search-plus"></i> Add New Building</a>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    {
        $('#building thead tr .hasinput').each(function(i)
        {
        ...
        $('#building').on('click', '.btn-delete[data-remote]', function (e) { 
            e.preventDefault();
            $.ajaxSetup({
                headers: {
