                          ...
                          <div class="modal-dialog modal-lg">
                              <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                      {!! Form::open(['action' => 'Space\SpaceSetting\SpaceCategoryController@store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                        ...
                        <div class="modal fade editModal" id="editModal" aria-hidden="true" >
                          <div class="modal-dialog modal-lg">
                              <div class="modal-content">
                                ...
                                {!! Form::open(['action' => ['Space\SpaceSetting\SpaceCategoryController@update', '1'], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
...
<script>
  ...
  $(document).ready(function() {
    ...
    $(document).on('click', '.edit_data', function(){
      ...
      $.ajax({
          url: '/space/space-setting/space-category/1/edit',
          method:"GET",
          data:{id:id},
          dataType:"json",
