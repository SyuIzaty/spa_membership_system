                          ...
                          <div class="col-md-12">
                            ...
                            <table class="table table-bordered">
                              <tr>
                                ...
                                <td style="width: 35%"><input type="number" class="form-control"></td>
                              ...
                              <tr>
                                ...
                                <td style="width: 85%" colspan="3"><input type="text" class="form-control"></td>
                              </tr>
                            </table>
                            ...
                            <table class="table table-bordered" id="head_field">
                              ...
                              <tr>
                                  <td>
                                      <select class="form-control evaluatee" name="evaluatee[]" required>
                                          <option disabled selected>Please Select</option>
                                          <option value="L">Laptop</option>
                                          <option value="C">Projector</option>
                                          <option value="C">Table</option>
                                      </select>
                                  </td>
                                  <td style="width: 20%">
