                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                          <div class="col-md-12">
                            ...
                            <a class="btn btn-success btn-sm float-right mb-2 mt-2 new" href="javascript:;" data-toggle="modal">Add Condition</a>
                          </div>
                        </div>
                          ...
                          <div class="modal-dialog modal-lg">
                              <div class="modal-content">
                                  <div class="modal-header">
                                      <h4 class="modal-title"> Add Space Condition</h4>
                                  </div>
                                  <div class="modal-body">
                                      {!! Form::open(['action' => 'Space\SpaceSetting\SpaceConditionController@store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <div class="custom-control custom-switch">
                                              <input type="checkbox" class="custom-control-input" name="status" id="store_enable">
                        ...
                        <div class="modal fade editModal" id="editModal" aria-hidden="true" >
                          <div class="modal-dialog modal-lg">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h4 class="modal-title">Update Space Condition</h4>
                                </div>
                                {!! Form::open(['action' => ['Space\SpaceSetting\SpaceConditionController@update', '1'], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                                <input type="hidden" name="condition_id" id="type_id">
                                <div class="modal-body">
                                  <table class="table table-bordered">
                                    <tr>
                                      <td>Name <span class="text-danger">*</span></td>
                                      <td><input type="text" class="form-control" name="name" id="room_name"></td>
                                    </tr>
                                    <tr>
                                      <td>Description <span class="text-danger">*</span></td>
                                      <td><input type="text" class="form-control" name="description" id="room_description"></td>
                                    </tr>
                                    <tr>
                                      <td>Status</td>
                                      <td>
...
<script>
  ...
  $(document).ready(function() {
    ...
    $(document).on('click', '.edit_data', function(){
      ...
      $.ajax({
          url: '/space/space-setting/space-condition/1/edit',
          method:"GET",
          data:{id:id},
          dataType:"json",
