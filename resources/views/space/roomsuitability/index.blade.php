...
<main id="js-page-content" role="main" class="page-content">
    ...
    <div class="subheader">
        ...
        <i class='subheader-icon fal fa-wrench'></i>Room Suitability<!--span class='fw-300'>ColumnFilter</span> <sup class='badge badge-primary fw-500'>ADDON</sup-->
            <!--small>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        Room Suitability <span class="fw-300"><i>List</i></span>
                    </h2>
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        ...
                        <table id="roomsuitability" class="table table-bordered table-hover table-striped w-100">
                            <thead>
                                <tr>
                                    <th>Code</th>
                                    <th>Name</th>
                    ...
                    <div class="panel-content py-2 rounded-bottom border-faded border-left-0 border-right-0 border-bottom-0 text-muted d-flex  pull-right">
                        ...
                        <a href="/space/roomsuitability/create" class="btn btn-primary ml-auto"><i class="fal fa-search-plus"></i> Add New Room Suitability</a>
...
<script>
    $(document).ready(function()
    {
        ...
        $('#roomsuitability thead tr .hasinput').each(function(i)
        {
        ...
        var table = $('#roomsuitability').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
                url: "/api/roomsuitability/list",
                type: 'POST',
        ...
        $('#roomsuitability').on('click', '.btn-delete[data-remote]', function (e) { 
            ...
            if (confirm('Are you sure you want to delete this?')) {
                $.ajax({
                    ...
                    $('#roomsuitability').DataTable().draw(false);
                });
            }else
