                    ...
                    <div class="panel-content">
                        <form action="{{ route('roomsuitability.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <p><span class="text-danger">*</span> Required fields</p>
                                ...
                                <a href="{{ URL::route('roomsuitability.index') }}" onclick="return confirm('Are you sure to discard data?')" class="btn btn-success ml-auto"><i class="fal fa-trash-alt"></i> Discard</a>
                        </form>
                    </div>
                </div>
            </div>
