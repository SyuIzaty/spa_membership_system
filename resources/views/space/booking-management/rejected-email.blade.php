          ...
          <td align="center"
              ...
              <table class="content" width="100%" cellpadding="0" cellspacing="0" role="presentation"
                  ...
                  <tr>
                      <td>
                          <div style="margin-left: 30px; line-height: 1em; color: black">
                              ...
                              <p>
                                Untuk makluman tuan/puan permohonan tempahan bilik & ruang {{ $destination }} pada
                                 {{ $departDate }} bagi tujuan {{ $purpose }} tidak DILULUSKAN.
                              </p>
                          </div><br>
                          <div style="margin-left: 30px; line-height: 1em; color: black">
                              <p>{{ $footer }}</p><br>
                  ...
                  <tr>
                      <td
                          style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative;">
                          <table class="footer" align="left" width="570" cellpadding="0" cellspacing="0"
                              role="presentation"
                              ...
                              <tr>
                                  <td class="content-cell" align="center"
                                      ...
                                      <p
                                          style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; line-height: 1.5em; margin-top: 0; color: #b0adc5; font-size: 12px; text-align: left;">
                                          © {{ \Carbon\Carbon::now()->format('Y') }} {{ config('app.name') }}. All
                                          rights reserved.</p>
                                  </td>
                              </tr>
                          </table>
