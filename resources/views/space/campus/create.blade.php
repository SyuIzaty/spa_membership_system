                            ...
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                              <p><span class="text-danger">*</span> Required fields</p>
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="{{ old('address1') }}" class="form-control @error('address1') is-invalid @enderror" id="address1" name="address1">
                                    @error('address1')
                                        <span class="invalid-feedback" role="alert">
                                            <strong> *{{ $message }} </strong>
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="{{ old('address2') }}" class="form-control @error('address2') is-invalid @enderror" id="address2" name="address2">
                                        @error('address2')
                                            <span class="invalid-feedback" role="alert">
                                                <strong> *{{ $message }} </strong>
                                            </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="{{ old('postcode') }}" class="form-control @error('postcode') is-invalid @enderror" id="postcode" name="postcode">
                                        @error('postcode')
                                            <span class="invalid-feedback" role="alert">
                                                <strong> *{{ $message }} </strong>
                                            </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="{{ old('city') }}" class="form-control @error('city') is-invalid @enderror" id="city" name="city">
                                        @error('city')
                                            <span class="invalid-feedback" role="alert">
                                                <strong> *{{ $message }} </strong>
                                            </span>
                                ...
                                <a href="{{ URL::route('campus.index') }}" onclick="return confirm('Are you sure to discard data?')" class="btn btn-success ml-auto"><i class="fal fa-trash-alt"></i> Discard</a>
                        </form>
                    </div>
                </div>
            </div>
