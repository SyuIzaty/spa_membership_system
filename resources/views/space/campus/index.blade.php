...
<main id="js-page-content" role="main" class="page-content">
    ...
    <div class="subheader">
        ...
        <i class='subheader-icon fal fa-university'></i>Campus<!--span class='fw-300'>ColumnFilter</span> <sup class='badge badge-primary fw-500'>ADDON</sup-->
            <!--small>
            ...
            <div id="panel-1" class="panel">
                ...
                <div class="panel-container show">
                        ...
                        <table id="campus" class="table table-bordered table-hover table-striped w-100">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td class="hasinput"><input type="text" class="form-control" placeholder="Search State"></td>
                                    <td class="hasinput">
                    ...
                    <div class="panel-content py-2 rounded-bottom border-faded border-left-0 border-right-0 border-bottom-0 text-muted d-flex  pull-right">
                        ...
                        <a href="/space/campus/create" class="btn btn-primary ml-auto"><i class="fal fa-search-plus"></i> Add New Campus</a>
...
<script>
    $(document).ready(function()
    {
        ...
        $('#campus thead tr .hasinput').each(function(i)
        {
