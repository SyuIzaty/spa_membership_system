                            ...
                            <table id="campus" class="table table-bordered table-hover table-striped w-100">
                              <thead>
                                ...
                                <div class="form-group">
                                    ...
                                    <td colspan="2"><input class="form-control @error('code') is-invalid @enderror" id="code" name="code" value="{{ $campus->code }}">
                                        @error('code')
                                    ...
                                    <td colspan="10"><input class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ $campus->name }}">
                                        @error('name')
                                            <span class="invalid-feedback" role="alert">
                                                <strong> *{{ $message }} </strong>
                                            </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <td colspan="10"><input class="form-control @error('description') is-invalid @enderror" id="description" name="description" value="{{ $campus->description }}">
                                        @error('description')
                                            <span class="invalid-feedback" role="alert">
                                                <strong> *{{ $message }} </strong>
                                            </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <td colspan="10"><input class="form-control @error('address1') is-invalid @enderror" id="address1" name="address1" value="{{ $campus->address1 }}">
                                        @error('address1')
                                            <span class="invalid-feedback" role="alert">
                                                <strong> *{{ $message }} </strong>
                                            </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <td colspan="10"><input class="form-control @error('address2') is-invalid @enderror" id="address2" name="address2" value="{{ $campus->address2 }}">
                                        @error('address2')
                                            <span class="invalid-feedback" role="alert">
                                                <strong> *{{ $message }} </strong>
                                            </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <td colspan="2"><input class="form-control @error('postcode') is-invalid @enderror" id="postcode" name="postcode" value="{{ $campus->postcode }}">
                                        @error('postcode')
                                            <span class="invalid-feedback" role="alert">
                                                <strong> *{{ $message }} </strong>
                                            </span>
                                    ...
                                    <td colspan="2"><input class="form-control @error('city') is-invalid @enderror" id="city" name="city" value="{{ $campus->city }}">
                                    @error('city')
                                            <span class="invalid-feedback" role="alert">
                                                <strong> *{{ $message }} </strong>
                                            </span>
