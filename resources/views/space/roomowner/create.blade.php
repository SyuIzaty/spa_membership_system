                        ...
                        <form action="{{ route('roomowner.store') }}" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" value="{{ old('dateofbirth') }}" class="form-control @error('dateofbirth') is-invalid @enderror" id="dateofbirth" name="dateofbirth">
                                    @error('dateofbirth')
                                    <span class="invalid-feedback" role="alert">
                                        <strong> *{{ $message }} </strong>
                                    </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <div value="{{ old('image') }}" class="col-sm-6 form-control @error('image') is-invalid @enderror"><input type="file" name="image" id="image"></div>
                                ...
                                <a href="{{ URL::route('roomowner.index') }}" onclick="return confirm('Are you sure to discard data?')" class="btn btn-success ml-auto"><i class="fal fa-trash-alt"></i> Discard</a>
                        </form>
                    </div>
                </div>
            </div>
