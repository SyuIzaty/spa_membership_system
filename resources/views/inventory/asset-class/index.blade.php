...
<main id="js-page-content" role="main" class="page-content" style="background-image: url({{asset('img/bg-form.jpg')}}); background-size: cover">
    <div class="subheader">
        ...
        <i class='subheader-icon fal fa-clone'></i>ASSET CLASS
        </h1>
    </div>
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        ASSET CLASS <span class="fw-300"><i>LIST</i></span>
                    </h2>
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        ...
                        <div class="table-responsive">
                            <table id="cls" class="table table-bordered table-hover table-striped w-100">
                                <thead>
                    ...
                    <div class="panel-content py-2 rounded-bottom border-faded border-left-0 border-right-0 border-bottom-0 text-muted d-flex pull-right">
                        <a href="javascript:;" data-toggle="modal" id="new" class="btn btn-primary ml-auto float-right"><i class="fal fa-plus-square"></i> Add New Asset Class</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="card-header bg-secondary text-white">
                    <h5 class="card-title w-100"><i class="fal fa-info width-2 fs-xl"></i>NEW ASSET CLASS</h5>
                </div>
                <div class="modal-body">
                    {!! Form::open(['action' => 'AssetClassController@addClass', 'method' => 'POST']) !!}
    ...
    <div class="modal fade" id="crud-modals" aria-hidden="true"  data-keyboard="false" data-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {!! Form::open(['action' => 'AssetClassController@updateCLass', 'method' => 'POST']) !!}
                    ...
                    <div class="form-group">
                        ...
                        <td colspan="5"><input class="form-control" id="codes" name="class_codes" style="text-transform: uppercase" required>
                            @error('class_codes')
                                <p style="color: red"><strong> * {{ $message }} </strong></p>
                            @enderror
                        </td>
...
<script>
    $(document).ready(function()
    {
        ...
        $('#cls thead tr .hasinput').each(function(i)
        {
        ...
        $('#cls').on('click', '.btn-delete[data-remote]', function (e) {
            e.preventDefault();
            $.ajaxSetup({
                headers: {
