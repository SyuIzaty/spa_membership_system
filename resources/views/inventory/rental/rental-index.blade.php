...
<main id="js-page-content" role="main" class="page-content" style="background-image: url({{asset('img/bg-form.jpg')}}); background-size: cover">
    <div class="subheader">
        ...
        <i class='subheader-icon fal fa-users'></i>RENTAL LIST MANAGEMENT
        </h1>
    </div>
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                ...
                <div class="panel-container show">
                    ...
                    <div class="panel-content py-2 rounded-bottom border-faded border-left-0 border-right-0 border-bottom-0 text-muted d-flex  pull-right">
                        <a class="btn btn-primary ml-auto" href="/rental-form"><i class="fal fa-plus-square"></i> Add New Renter</a><br><br>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    $(document).ready(function()
    {
        ...
        var table = $('#rental').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "/data-rental-list",
                type: 'POST',
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')}
            },
            columns: [
                    { className: 'text-center', data: 'id', name: 'id' },
                    { className: 'text-center', data: 'staff_id', name: 'staff.name' },
