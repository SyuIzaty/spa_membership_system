                    ...
                    <tr>
                        <td>
                            <div style="margin-left: 30px; line-height: 1em; color: black">
                                <p>Assalamualaikum wbt. and Greetings.</p>
                                <p style="line-height: 1em">Sir/Madam/Mr/Ms.</p>
                                <p style="line-height: 1.5em">{{ $app_description }}</p>
                                <p>Kindly login to the <a href="https://ids.intec.edu.my/login" style="text-decoration: none; color: #3498db;"><u>INTEC Digital Services (IDS)</u></a> for more information.</p>
                                <p>Thank you.</p>
                                <p style="font-size: 10px;">This email is automatically generated from system, and there is no need to reply.</p>
                            </div><br><br>
                        </td>
                    </tr>
