...
<main id="js-page-content" role="main" class="page-content" style="background-image: url({{asset('img/bg-form.jpg')}}); background-size: cover">
    <div class="subheader">
        ...
        <i class='subheader-icon fal fa-clone'></i>ASSET TYPE MANAGEMENT
        </h1>
    </div>
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                ...
                <div class="panel-container show">
                    ...
                    <div class="panel-content py-2 rounded-bottom border-faded border-left-0 border-right-0 border-bottom-0 text-muted d-flex pull-right">
                        <a href="javascript:;" data-toggle="modal" id="new" class="btn btn-primary ml-auto float-right"><i class="fal fa-plus-square"></i> Add Asset Type</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="card-header bg-secondary text-white">
                    <h5 class="card-title w-100"><i class="fal fa-info width-2 fs-xl"></i>ADD NEW ASSET TYPE</h5>
                </div>
                <div class="modal-body">
                    {!! Form::open(['action' => 'Inventory\AssetParameterController@store_asset_type', 'method' => 'POST']) !!}
    ...
    <div class="modal fade" id="crud-modals" aria-hidden="true" data-keyboard="false" data-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {!! Form::open(['action' => 'Inventory\AssetParameterController@update_asset_type', 'method' => 'POST']) !!}
    ...
    $(document).ready(function()
    {
        ...
        var table = $('#type').DataTable({
            ...
            columns: [
                    ...
                    { className: 'text-center', data: 'department_id', name: 'department.department_name' },
