                    ...
                    <tr>
                        <td>
                            <div style="margin-left: 30px; line-height: 1em; color: black">
                                ...
                                @if(isset($membership_id))<p>Membership ID ID : <b>{{ $membership_id }}</b></p>@endif
                                @if(isset($membership_start))<p>Membership Start Date : <b>{{ $membership_start }}</b></p>@endif
                                @if(isset($membership_end))<p>Membership End Date : <b>{{ $membership_end }}</b></p>@endif
                                @if(isset($membership_payment))<p>Payment Amount : <b>{{ $membership_payment }}</b></p>@endif
                                @if(isset($membership_payment_status))<p>Payment Status : <b>{{ $membership_payment_status }}</b></p>@endif
