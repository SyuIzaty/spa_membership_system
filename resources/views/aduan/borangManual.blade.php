...
<main id="js-page-content" role="main" class="page-content">
    <div class="row">
        <div class="col-xl-12" style="padding: 50px; margin-bottom: 20px">
                ...
                <center><img src="{{ URL::to('/') }}/img/intec_logo_new.png" style="height: 120px; width: 320px;" alt="INTEC" style="margin-top: -65px"></center><br>
                ...
                <table class="table table-bordered table-hover w-100">
                    <tr>
                        <td colspan="6" style="background-color: rgb(228, 228, 228)"><label class="form-label">INFO ADUAN</label></td>
                    </tr>
                    <tr>
                        <div class="form-group">
                            <td width="15%"><label class="form-label" for="tarikh_laporan">Tarikh Aduan Dibuat :</label></td>
                            <td colspan="2">{{ date('j F Y | h:i:s A', strtotime($aduan->tarikh_laporan) )}}</td>
                    ...
                    <tr>
                        <div class="form-group">
                            <td width="15%"><label class="form-label" for="nama_pelapor">Nama Pelapor :</label></td>
                            <td colspan="1">{{ strtoupper($aduan->nama_pelapor ?? '--')  }}</td>
                            <td width="15%"><label class="form-label" for="emel_pelapor">Emel Pelapor :</label></td>
                            <td colspan="1">{{ $aduan->emel_pelapor ?? '--'  }}</td>
                            <td width="15%"><label class="form-label" for="no_tel_pelapor">No Telefon Pelapor :</label></td>
                            <td colspan="1">{{ $aduan->no_tel_pelapor ?? '--'  }}</td>
                        </div>
                    </tr>
                    <tr>
                        <div class="form-group">
                            <td width="15%"><label class="form-label" for="lokasi">Lokasi :</label></td>
                            <td colspan="1">
                            ...
                            <td width="15%"><label class="form-label" for="kuantiti_unit">Kuantiti/Unit :</label></td>
                            <td colspan="1">{{ $aduan->kuantiti_unit ?? '--'  }}</td>
                            <td width="15%"><label class="form-label" for="maklumat_tambahan">Maklumat Tambahan :</label></td>
                            <td colspan="1">{{ strtoupper($aduan->maklumat_tambahan ?? '--')  }}</td>
                        </div>
                    </tr>
                    <tr>
                        <div class="form-group">
                            <td width="15%" style="vertical-align: middle"><label class="form-label" for="aduan">Aduan :</label></td>
                    ...
                    {{-- <tr>
                        <div class="form-group">
                            <td width="15%" style="vertical-align: middle"><label class="form-label" for="maklumat_tambahan">Gambar :</label></td>
                            <td colspan="2">
                            ...
                            <td width="15%" style="vertical-align: middle"><label class="form-label" for="maklumat_tambahan">Resit :</label></td>
                            <td colspan="2" style="vertical-align: middle">
