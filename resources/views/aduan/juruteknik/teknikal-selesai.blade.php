    ...
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        SENARAI <span class="fw-300"> ADUAN SELESAI</span>
                    </h2>
    ...
    $(document).ready(function()
    {
        ...
        var table = $('#senarai').DataTable({
            ...
            columns: [
                    ...
                    { className: 'text-center', data: 'pengesahan_pembaikan', name: 'aduan.pengesahan_pembaikan', orderable: false, searchable: false },
