...
<main id="js-page-content" role="main" class="page-content" style="background-image: url({{asset('img/bg-form.jpg')}}); background-size: cover">
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-list-alt'></i>BORANG E-ADUAN FASILITI - TIKET ID : {{$aduan->id}}
        </h1>
    </div>
    <div class="row">
        <div class="col-xl-12">
                    ...
                    <div class="row">
                        ...
                        @elseif(Auth::user()->hasPermissionTo('view complaint - technician'))
                            ...
                            @else
                                <div class="col-md-12">
                            @endif
                        @elseif(Auth::user()->hasPermissionTo('view complaint - HEP'))
                            <div class="col-md-12">
                        @endif
                            <div class="card card-primary card-outline p-4">
                                ...
                                <h4 style="text-align: center">
                                    <b>BORANG E-ADUAN FASILITI - TIKET ID : {{$aduan->id}}</b>
                                </h4>
                                <center>
                                                ...
                                                <div class="alert alert-success alert-dismissible fade show">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-1 pl-1">
                                                            PEMBAIKAN ADUAN TELAH DISAHKAN OLEH PENGADU
                                                        </div>
                                                    </div>
                                                </div>
                                            @else
                                                <div class="alert alert-danger alert-dismissible fade show">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-1 pl-1">
                                                            PEMBAIKAN ADUAN BELUM DISAHKAN OLEH PENGADU
                                                        </div>
                                                    </div>
                                                </div>
                                            @endif
                                                ...
                                                <thead>
                                                    ...
                                                    <tr>
                                                        <div class="form-group">
                                                            ...
                                                            <td colspan="4">
                                                                <label for="ak_upah"> @if(isset($aduan->ak_upah)) RM {{ $aduan->ak_upah }} @else TIADA @endif</label><br><br>
                                                                <label for="ak_bahan_alat">@if(isset($aduan->ak_bahan_alat)) RM {{ $aduan->ak_bahan_alat }}@else TIADA @endif</label>
                                                            </td>
                                                        </div>
                                                    </tr>
                                                    <tr>
                                                        <div class="form-group">
                                                            ...
                                                            <td colspan="4" style="background-color: #ddd; cursor: not-allowed;">
                                                                @if(isset($aduan->jumlah_kos)) RM {{ $aduan->jumlah_kos }}@else TIADA @endif
                                                            </td>
                                                        </div>
                                                    </tr>
                        ...
                        <div class="col-md-5 col-sm-12">
                                                                ...
                                                                <td colspan="2">
                                                                        <div class="test" id="test">
                                                                            ...
                                                                            @if(session()->has('kemaskiniTahap'))
                                                                                <div class="alert alert-success" style="color: #3b6324"> <i class="icon fal fa-check-circle"></i>
                                    ...
                                    @if($aduan->status_aduan == 'DJ')
                                        <div class="card card-primary card-outline">
                                            ...
                                            <div class="card-body">
                                                            ...
                                                            <tr>
                                                                <div class="form-group">
                                                                    <td colspan="2">
                                                                        ...
                                                                        <option value="" disabled selected>Sila Pilih</option>
                                                                            @foreach($status->whereIn('kod_status', ['TD', 'AK', 'DP']) as $stt)
                                                ...
                                                <button type="submit" class="btn btn-danger float-right" id="submitheads"><i class="fal fa-save"></i> Simpan Pembaikan</button>
                                                {!! Form::close() !!}
                                            </div>
                                        </div>
                                        <br><br>
                            ...
                            @can('view complaint - admin')
                                @if($aduan->status_aduan == 'TD' && $aduan->pengesahan_pembaikan != 'Y')
                                    <div class="card card-primary card-outline">
                                        <div class="card-header">
                                            <h5 class="card-title w-100"><i class="fal fa-cube width-2 fs-xl"></i>PENGESAHAN PEMBAIKAN ADMIN</h5>
                                        </div>
                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group">
                                                                <td colspan="2">
                                                                    <select class="form-control status_adu" name="status_aduan" id="status_aduan" required>
                                                                        <option value="" disabled selected>Sila Pilih</option>
                                                                        @foreach ($status->whereIn('kod_status', ['AS', 'LK', 'LU']) as $stats)
