    ...
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        SENARAI <span class="fw-300">JENIS KEROSAKAN</span>
                    </h2>
                ...
                <div class="panel-container show">
                    ...
                    <div class="panel-content py-2 rounded-bottom border-faded border-left-0 border-right-0 border-bottom-0 text-muted d-flex  pull-right">
                        <a href="javascript:;" data-toggle="modal" id="new" class="btn btn-info ml-auto float-right"><i class="fal fa-plus-square"></i> Tambah Jenis Kerosakan</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="modal-body">
                    ...
                    <p><span class="text-danger">*</span> Maklumat wajib diisi</p>
                        ...
                        <div class="form-group">
                            ...
                            <td colspan="4"><input value="{{ old('jenis_kerosakan') }}" class="jenis_kerosakan form-control" id="jenis_kerosakan" name="jenis_kerosakan" required>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <td colspan="5">
                            <select class="kategori form-control" name="kategori_aduan" id="kategori_aduan" disabled>
                                <option value="" selected disabled>Sila Pilih</option>
                                @foreach($kategori as $kat)
                    ...
                    <div class="form-group">
                        ...
                        <td colspan="5"><input class="jenis form-control" id="jenis_kerosakan" name="jenis_kerosakan" required>
                            @error('jenis_kerosakan')
                                <p style="color: red"><strong> * {{ $message }} </strong></p>
                            @enderror
                        </td>
...
<script>
    $(document).ready(function()
    {
        ...
        $('#crud-modals').on('show.bs.modal', function(event) {
            ...
            $('.modal-body .jenis').val(kerosakan);
