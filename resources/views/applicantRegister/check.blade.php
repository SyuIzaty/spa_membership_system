            ...
            success: function(response){
                ...
                if(len > 0){
                    for(var i=0; i<len; i++){
                        ...
                        {
                            var tr_str = "<h4 class='d-flex justify-content-lg-center'>Congratulation " + applicant_name + "!</h4><br>" +
                            "<div class='card'>"+
                                "<div class='card-body col-md-12'><a href='/letter?applicant_id="+id+"'>Offer Letter</a></div>"+
                                "</div>";
                        }else{
