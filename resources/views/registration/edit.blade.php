                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 form-group">
                                                    ...
                                                    {{ Form::text('applicant_address_1', '', ['class' => 'form-control', 'placeholder' => 'Address Line 1','onkeyup' => 'this.value = this.value.toUpperCase()']) }}
                                                    @error('applicant_phone')
                                                        <p style="color: red">{{ $message }}</p>
                                                    @enderror
                                                </div>
                                                <div class="col-md-12 form-group">
                                                    ...
                                                    {{ Form::text('applicant_address_2', '', ['class' => 'form-control', 'placeholder' => 'Address Line 2', 'onkeyup' => 'this.value = this.value.toUpperCase()']) }}
                                                </div>
                                                <div class="col-md-6 form-group">
                                                ...
                                                <div class="col-md-6 form-group">
                                                    ...
                                                    {{ Form::text('applicant_city', '', ['class' => 'form-control', 'placeholder' => 'City', 'onkeyup' => 'this.value = this.value.toUpperCase()']) }}
                                                ...
                                                <div class="col-md-6 form-group">
                                                    ...
                                                    {{ Form::text('applicant_state', '', ['class' => 'form-control', 'placeholder' => 'State', 'onkeyup' => 'this.value = this.value.toUpperCase()']) }}
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    {{Form::text('guardian_one_name', '', ['class' => 'form-control', 'placeholder' => 'Guardian Name', 'onkeyup' => 'this.value = this.value.toUpperCase()'])}}
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    {{Form::text('guardian_one_address', '', ['class' => 'form-control', 'placeholder' => 'Guardian Address', 'onkeyup' => 'this.value = this.value.toUpperCase()'])}}
                                            ...
                                            <div class="row mt-5">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    {{Form::text('guardian_two_name', '', ['class' => 'form-control', 'placeholder' => 'Guardian II Name', 'onkeyup' => 'this.value = this.value.toUpperCase()'])}}
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    {{Form::text('guardian_two_address', '', ['class' => 'form-control', 'placeholder' => 'Guardian Address', 'onkeyup' => 'this.value = this.value.toUpperCase()'])}}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    {{Form::text('emergency_name', '', ['class' => 'form-control', 'placeholder' => 'Emergency Name', 'onkeyup' => 'this.value = this.value.toUpperCase()'])}}
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    {{Form::text('emergency_address', '', ['class' => 'form-control', 'placeholder' => 'Guardian Address', 'onkeyup' => 'this.value = this.value.toUpperCase()'])}}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
