    ...
    <body>
        <div class="login-box">
            <div class="login-snip">
                ...
                <label for="tab-1" class="tab" style="font-family: 'PT Serif', serif; font-weight: 500;">Reset Password</label>
                ...
                <div class="login-space">
                    <div class="login">
                        ...
                        <form method="POST" action="{{ route('resetPassword') }}">
                            @csrf
                            <div class="group">
                                <label for="email" class="label" style="margin-bottom: 10px; margin-top: 40px">Email Address</label>
                                <input id="email" type="email" class="input @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required>
                            </div>
                            <br>
                            <div class="group">
                                <label for="password" class="label" style="margin-bottom: 10px">New Password</label>
                                <input id="password" type="password" class="input @error('password') is-invalid @enderror" name="password" required autocomplete="off">
                            </div>
                            <br>
                            <div class="group">
                                <label for="password_confirmation" class="label" style="margin-bottom: 10px">Repeat New Password</label>
                        ...
                        <div class="foot" style="text-align: right; font-size: 12px;">
                            <a href="/login" style="display: block; text-decoration: none; color: #fff;">
                                <i class="fa fa-key" style="margin-right: 5px;"></i> Login
                            </a><br>
