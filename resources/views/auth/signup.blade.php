    ...
    <body>
        <div class="login-box">
            <div class="login-snip">
                ...
                <label for="tab-1" class="tab" style="font-family: 'PT Serif', serif; font-weight: 500;">Signup</label>
                ...
                <div class="login-space">
                    <div class="login">
                        ...
                        @endif
                        <form method="POST" action="{{ route('registerSignup') }}">
                            @csrf
                            <div class="group">
                            ...
                            <br>
                            <div class="group">
                                <label for="phone" class="label" style="margin-bottom: 10px">Phone No.</label>
