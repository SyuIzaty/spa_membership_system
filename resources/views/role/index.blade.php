                        ...
                        <div class="panel-content">
                            ...
                            <table class="table table-bordered" id="role">
                                <thead>
                                    ...
                                    <tr>
                                        <td class="hasinput"><input type="text" class="form-control" placeholder="Search Role ID"></td>
                                        <td class="hasinput"><input type="text" class="form-control" placeholder="Search Role Name"></td>
...
<script>
    $(document).ready(function()
    {
        ...
        $('#role thead tr .hasinput').each(function(i)
        {
    ...
    $('#role').on('click', '.btn-delete[data-remote]', function (e) {
            e.preventDefault();
            $.ajaxSetup({
                headers: {
