                          ...
                          <div class="modal-dialog modal-lg">
                              <div class="modal-content">
                                  <div class="modal-header">
                                      <h4 class="modal-title"> Add Task Priority</h4>
                                  </div>
                                  <div class="modal-body">
                                      {!! Form::open(['action' => 'Task\TaskSetting\TaskPriorityController@store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                                      <table class="table table-bordered">
                                        <tr>
                                          <td style="width: 30%">Priority Status <span class="text-danger">*</span></td>
                        ...
                        <div class="modal fade editModal" id="editModal" aria-hidden="true" >
                          <div class="modal-dialog modal-lg">
                              <div class="modal-content">
                                ...
                                {!! Form::open(['action' => ['Task\TaskSetting\TaskPriorityController@update', '1'], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
...
<script>
  ...
  $(document).ready(function() {
      ...
      $(document).on('click', '.edit_data', function(){
        ...
        $.ajax({
            url: '/task/task-setting/task-priority/1',
            method:"GET",
            data:{id:id},
            dataType:"json",
