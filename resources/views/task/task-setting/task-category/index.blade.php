                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                          <div class="col-md-12">
                            ...
                            <a class="btn btn-success btn-sm float-right mb-2 mt-2" href="javascript:;" data-toggle="modal" id="new">Add Task Category</a>
                          </div>
                        </div>
                          ...
                          <div class="modal-dialog modal-lg">
                              <div class="modal-content">
                                  <div class="modal-header">
                                      <h4 class="modal-title"> Add Task Category</h4>
                                  </div>
                                  <div class="modal-body">
                                      {!! Form::open(['action' => 'Task\TaskSetting\TaskCategoryController@store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                        ...
                        <div class="modal fade editModal" id="editModal" aria-hidden="true" >
                          <div class="modal-dialog modal-lg">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h4 class="modal-title">Update Task Category</h4>
                                </div>
                                {!! Form::open(['action' => ['Task\TaskSetting\TaskCategoryController@update', '1'], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                                ...
                                <div class="modal-body">
                                  <table class="table table-bordered">
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        <div class="custom-control custom-switch">
                                          <input type="checkbox" class="custom-control-input" name="status_id" id="status_edit">
...
<script>
  ...
  $(document).ready(function() {
      ...
      $(document).on('click', '.edit_data', function(){
        ...
        $.ajax({
            url: '/task/task-setting/task-category/1',
            method:"GET",
            data:{id:id},
            dataType:"json",
